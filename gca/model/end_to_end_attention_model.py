...
attention_func = Attention(num_units=300, num_heads=6, drop_rate=0)#drop_rate_placeholder)
...
# embedding_decayed_learning_rate = tf.train.exponential_decay(learning_rate, global_step, 10000, 0.9999)
...
# attention_decayed_learning_rate = tf.train.exponential_decay(attention_learning_rate, global_step, 100000, 0.99999)
# embedding_decayed_learning_rate = 1e-1
# attention_decayed_learning_rate = 2e-3
# l2_coe = 1e-3


print("lr = {}\talr = {}\tl2_coe = {}".format(learning_rate, attention_learning_rate, l2_coe))
    ...
    for step in range(1000000):
        ...
        for meta_index, (node_types, mean_meta_loss, optimizer) in enumerate(zip(node_types_list, mean_meta_losses, optimizers)):
            ...
            feed_dict = {
                ...
                drop_rate_placeholder: dropout_rate
